	...
	VMM.MediaElement = ({
		...
		create: function(data, uid) {
			...
			// FLICKR
					...
					mediaElem			=	"<div class='media-image media-shadow'  ><div class=\"button small pop1\" data-bpopup='{\"follow\":[false,false],\"position\":[150,400]}'>Pop it up</div><a href='" + m.link + "' target='_blank'><img id='" + uid + "'></a></div>";
			...
			// YOUTUBE
					...
					mediaElem			=	"<div class='media-shadow'><div class=\"button small pop1\" data-bpopup='{\"follow\":[false,false],\"position\":[150,400]}'>Pop it up</div><div class='media-frame video youtube' id='" + uid + "'>" + loading_messege + "</div></div>";
